...
{
    PackedScene TomatoHarvestSceneLoader = ResourceLoader.Load<PackedScene>("res://scenes/objects/plants/TomatoHarvest.tscn");
    ...
    public override void _Process(double delta){
        ...
        // 根据不同的状态，设置不同的动画帧
        sprite2D.Frame = (int)growthState + startTomatoFrameoffset;
    ...
    public void onCorpHarvesting(){
        // 作物收割完成后，加载收割场景
        var TomatoHarvestScene = TomatoHarvestSceneLoader.Instantiate() as Node2D;
        
        // 设置节点位置
        TomatoHarvestScene.GlobalPosition = this.GlobalPosition;
        
        this.GetParent().AddChild(TomatoHarvestScene);
